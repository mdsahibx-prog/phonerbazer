...
export const ANALYTICS_EVENT_REGISTRY: AnalyticsEventDefinition[] = [
  ...
  { name: 'begin_checkout', category: 'checkout', required: false, marketing: false, description: 'Checkout was initiated.', providers: ['GA4', 'GTM', 'META_PIXEL', 'TIKTOK_PIXEL', 'TIKTOK_EVENTS_API'] },
  ...
  { name: 'purchase', category: 'purchase', required: true, marketing: false, description: 'A successful order was recorded from authoritative server data.', providers: ['GA4', 'GTM', 'META_PIXEL', 'META_CAPI', 'TIKTOK_PIXEL', 'TIKTOK_EVENTS_API', 'SERVER_GTM'] },
  ...
  { name: 'generate_lead', category: 'lead', required: false, marketing: true, description: 'A lead form was submitted with consent.', providers: ['GA4', 'GTM', 'META_PIXEL', 'META_CAPI', 'TIKTOK_PIXEL', 'TIKTOK_EVENTS_API'] },
  { name: 'contact', category: 'support', required: false, marketing: true, description: 'A contact action occurred with consent.', providers: ['GA4', 'GTM', 'META_PIXEL', 'META_CAPI', 'TIKTOK_PIXEL', 'TIKTOK_EVENTS_API'] },
  ...
  { name: 'sign_up', category: 'support', required: false, marketing: true, description: 'A user completed registration.', providers: ['GA4', 'GTM', 'META_PIXEL', 'META_CAPI', 'TIKTOK_PIXEL', 'TIKTOK_EVENTS_API'] },
  { name: 'whatsapp_click', category: 'support', required: false, marketing: true, description: 'A WhatsApp support action occurred with marketing consent.', providers: ['GA4', 'GTM', 'META_PIXEL', 'META_CAPI', 'TIKTOK_PIXEL', 'TIKTOK_EVENTS_API'] },
