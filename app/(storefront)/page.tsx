...
export default async function HomePage() {
  ...
  return (
    <main className="flex-1 overflow-x-hidden bg-[#f7f7f7]">
      <HeroSection banners={banners} productCount={allProducts.length} brandCount={brands.length} categoryCount={categories.length} />

      <section className="border-b border-slate-200 bg-white py-3 sm:py-4" aria-label="Shopping benefits">
      ...
      <section className="bg-white py-5 sm:py-10" aria-labelledby="featured-categories-heading">
        <div className="mx-auto max-w-7xl px-3 sm:px-6 lg:px-8">
          <div className="flex items-end justify-between gap-3">
            <div><p className="text-[10px] font-black uppercase tracking-[0.16em] text-orange-500">Shop by type</p><h2 id="featured-categories-heading" className="mt-1 text-xl font-black tracking-tight text-slate-950 sm:text-3xl">Featured <span className="text-orange-500">Categories</span></h2></div>
      ...
      {bestDeals.length > 0 && (
        <section className="border-y border-orange-100 bg-orange-50/50 py-5 sm:py-10" aria-labelledby="deals-heading">
          <div className="mx-auto max-w-7xl px-3 sm:px-6 lg:px-8">
      ...
      {brands.length > 0 && (
        <section className="bg-white py-5 sm:py-10" aria-labelledby="brands-heading">
          <div className="mx-auto max-w-7xl px-3 sm:px-6 lg:px-8">
