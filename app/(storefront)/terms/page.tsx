...
export default function TermsPage() {
  return <PolicyPage
    ...
    description="These terms explain how PhonerBazar handles product information, orders, verification, delivery, customer responsibilities, and support. They are intended to be read together with the applicable product and service policies."
    sections={[
      { id: 'introduction', title: '1. Introduction', body: 'By using the PhonerBazar website or placing an order, you agree to use the service lawfully and to provide information that is accurate enough for order verification and delivery. These terms are subject to applicable Bangladesh law and do not remove mandatory customer rights.' },
      ...
      { id: 'product-information', title: '3. Product information', paragraphs: [
        'PhonerBazar makes reasonable efforts to maintain accurate product names, descriptions, specifications, images, variants, stock information, and prices. Product appearance, packaging, accessories, or manufacturer specifications may vary where applicable.',
      ...
      { id: 'cod-verification', title: '6. Cash on Delivery verification', bullets: [
        'For Cash on Delivery orders, PhonerBazar may contact the customer to verify the name, phone number, delivery address, product, quantity, and order intent.',
        'Customers should cooperate with reasonable order verification and delivery communication.',
        'Where legally permissible, PhonerBazar may refuse or cancel suspicious, fraudulent, duplicate, abusive, unverifiable, or clearly erroneous orders.',
        'No arbitrary cancellation fee is created by these terms.'
      ]},
      { id: 'cancellation', title: '7. Order cancellation', body: 'A customer should contact PhonerBazar as soon as possible if an order needs correction or cancellation. Whether a cancellation is possible may depend on order status, verification, dispatch progress, product availability, and applicable law.' },
      { id: 'delivery', title: '8. Delivery', body: 'Delivery is available across Bangladesh. Current charges are ৳80 inside Dhaka and ৳130 outside Dhaka. Timing may vary due to location, courier conditions, weather, holidays, address problems, customer unavailability, operational disruption, or circumstances outside PhonerBazar’s reasonable control. See the Shipping & Delivery policy for details.' },
      ...
      { id: 'warranty', title: '10. Warranty and service', body: 'PhonerBazar’s standard support framework includes a 7-day guarantee and a 1-year service warranty, subject to eligibility, verification, product condition, and applicable manufacturer terms. See the Warranty & Guarantee policy.' },
      ...
      { id: 'fraud-abuse', title: '12. Fraudulent or abusive orders', body: 'PhonerBazar may review repeated failed deliveries, multiple or fake orders, abusive communications, misuse of offers, payment or identity concerns, and other conduct that creates a reasonable risk of fraud or operational abuse. Actions will be taken subject to applicable law and the circumstances of the case.' },
      { id: 'intellectual-property', title: '13. Intellectual property', body: 'The PhonerBazar name, branding, written content, images, design elements, and website materials belong to PhonerBazar or their respective rights holders. They may not be copied, republished, or commercially reused without permission, except where permitted by law.' },
      { id: 'availability-errors', title: '14. Website availability and corrections', body: 'PhonerBazar works to keep the website available and information useful, but pages, features, and data may occasionally be unavailable, delayed, or corrected. PhonerBazar may update information, fix errors, or temporarily suspend a feature where reasonably necessary.' },
      { id: 'liability', title: '15. Limitation of liability', body: 'To the extent legally permissible, PhonerBazar is not responsible for losses caused by inaccurate customer information, customer unavailability, misuse of a product, events outside reasonable control, or reliance on an obvious website error. Nothing in these terms excludes or limits liability or customer rights that cannot lawfully be excluded.' },
