...
export default function PrivacyPage() {
  return <PolicyPage
    ...
    description="This policy explains the types of information PhonerBazar may receive, why it is used, how it supports order operations, and the practical choices available to customers. It is subject to applicable Bangladesh law."
    sections={[
      { id: 'introduction', title: '1. Introduction', body: 'PhonerBazar respects customer privacy and uses information for legitimate store operations, including order fulfillment, delivery coordination, customer support, warranty and return handling, fraud prevention, and website functionality. This policy describes the current customer-facing approach and may be updated when services or requirements change.' },
      ...
      { id: 'service-providers', title: '5. Service providers and infrastructure', body: 'PhonerBazar uses third-party operational infrastructure for hosting, database, storage, authentication, and website delivery. Customer information may be processed by those providers when necessary for the store to function. Operational delivery or communication partners may also receive information needed to fulfill a specific order. PhonerBazar does not claim that data is never processed by third-party infrastructure.' },
      { id: 'security', title: '6. Security', body: 'PhonerBazar uses reasonable technical and organizational measures appropriate to the application and its operational needs. No online service can promise absolute security, so customers should avoid sharing unnecessary sensitive information through ordinary support channels.' },
      ...
      { id: 'customer-choices', title: '9. Customer choices and requests', paragraphs: [
        'Customers may contact PhonerBazar to ask about an order-related record, correct inaccurate delivery information, or raise a privacy concern. Some information must be retained or used when necessary for order fulfillment, warranty, business records, fraud prevention, legal obligations, or dispute resolution.',
