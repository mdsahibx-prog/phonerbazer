...
export function AssistantButton({ enabled = true, maintenanceMode = false, maintenanceMessage, assistantName = 'PhonerBazar AI Assistant', subtitle = 'বাংলায় পণ্য ও স্টোর সহায়তা', buttonLabel = 'সাহায্য লাগবে?', maxVisibleProductCards = 4, showQuickPrompts = true, welcomeMessage, quickPrompts }: { enabled?: boolean; maintenanceMode?: boolean; maintenanceMessage?: string; assistantName?: string; subtitle?: string; buttonLabel?: string; maxVisibleProductCards?: number; showQuickPrompts?: boolean; welcomeMessage?: string; quickPrompts?: string[] }) {
  ...
  return (
    <>
      <button
        ...
        aria-expanded={open}
        aria-controls="phonerbazar-assistant-panel"
