-- Production fix: customer_addresses has no is_default column.
...
BEGIN
  ...
  INSERT INTO public.customer_addresses (customer_id, division, district, area, address, postal_code)
  VALUES (
    v_customer_id,
    btrim(p_division),
    btrim(p_district),
